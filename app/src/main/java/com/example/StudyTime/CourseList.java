...
public class CourseList {
    ...
    public void initialize(Context context) {
        ...
        if (size == 0) {
            courseMap.put(0, new Course("Select your course:"));
            size += 1;
        }
    ...
    public void addCourse(String addMe) {
        courseMap.put(size, new Course(addMe));
        size += 1;
        saveCourses();
    }
...
//    }
    ...
    public void loadCourses() {
        ...
        if (courseFH.fileExists()) {
            courseMap = gson.fromJson(courseFH.readFromFile(), new TypeToken<Map<Integer, Course>>(){
            }.getType());
        }
    }
